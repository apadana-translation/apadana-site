...
[^4]: reading *pari<span class="diacritics" data-state="on">c</span><span class="no-diacritics" data-state="off">ch</span>ārem’* (<dfn id="#PTS"><abbr title="Pali Text Society">PTS</abbr></dfn>, <a href="#PTS" class="abbr">PTS</a> alt) for *parivārem’* (“being surrounded,” <a href="#PTS" class="abbr">PTS</a>, but also with the sense of “waiting upon”).
