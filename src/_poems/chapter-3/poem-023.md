...
[^2]: some alt. <dfn id="#PTS"><abbr title="Pali Text Society">PTS</abbr></dfn> mss. as well as cty read Baṇḍumatī; <dfn id="#BJTS"><abbr title="Buddha Jayanthi Tripitaka Series">BJTS</abbr></dfn> like <a href="#PTS" class="abbr">PTS</a> reads [C]{.diacritics data-state=on}[Ch]{.no-diacritics data-state=off}aṇḍavatī. See DPPN I:851; the city is only “known” to have existed during the time of previous Buddhas (and during the previous lives of Gotama Buddha).
