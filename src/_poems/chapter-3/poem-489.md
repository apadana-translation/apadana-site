...
### \[486. {489.}[^1] Dhammaru[c]{.diacritics data-state=on}[ch]{.no-diacritics data-state=off}ī[^2]\]
...
[C]{.diacritics data-state=on}[Ch]{.no-diacritics data-state=off}itta and Ālavaka will  
...
My name was Dhammaru[c]{.diacritics data-state=on}[ch]{.no-diacritics data-state=off}ī \[then\],  
...
called \[me\] “long time Dhammaru[c]{.diacritics data-state=on}[ch]{.no-diacritics data-state=off}ī.”  
