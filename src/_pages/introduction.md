...
[^1]: On the composition history of the collection see my {% cite "walters_stupa-story-empire", { suppressAuthor: true } %}
...
[^4]: A most remarkable second *Buddhāpadāna*, which uniquely describes
    ...
    see my {% cite "walters_buddhas-bad-karma", { suppressAuthor: true } %})
